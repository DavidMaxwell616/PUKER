class puker.SkewScroller
{
   ...
   function init()
   {
      ...
      {
         var _loc3_ = this.lRoot.attachMovie("_mFloor_" + this.app.gameLevel,"mTile" + _loc2_,50 + _loc2_,{_y:150,_x:puker.SkewScroller.STAGEWIDTH / 2 * _loc2_});
         var _loc4_ = _loc3_.transform.matrix;
   ...
   function addHitItem()
   {
      ...
      {
         this.newNumber = this.newNumber + 1;
         var _loc2_ = this.lRoot.attachMovie("_mItem_" + this.app.gameLevel,"mItem" + this.newNumber,this.lRoot.getNextHighestDepth());
         _loc2_.Blur_blurY = 0;
   ...
   function updatePersp()
   {
      ...
      {
         var _loc2_ = this.lRoot["mTile" + _loc5_];
