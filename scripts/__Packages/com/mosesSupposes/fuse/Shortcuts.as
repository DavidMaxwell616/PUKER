class com.mosesSupposes.fuse.Shortcuts
{
   ...
   static function doShortcut(obj, methodName)
   {
      ...
      {
         var _loc2_ = String(_loc5_.apply(obj[_loc6_],arguments));
   ...
   static function parseStringTypeCallback(callbackStr)
   {
      ...
      var evaluateList = function(list)
      {
         ...
         while(_loc4_ < list.length)
         {
            ...
            var _loc5_ = _loc3_.charAt(0) == "{" && (_loc3_.indexOf("}") > -1 || _loc3_.indexOf(":") > -1);
            var _loc10_ = _loc3_.charAt(0) == "[";
            if((_loc5_ || _loc10_) == true)
            {
               var _loc6_ = _loc5_ != true ? [] : {};
               var _loc2_ = _loc4_;
               while(_loc2_ < list.length)
               {
                  ...
                  var _loc8_ = _loc1_.slice(-1) == (_loc5_ != true ? "]" : "}") || _loc2_ == list.length - 1;
                  if(_loc8_ == true)
                  {
