class puker.SubGame extends MovieClip
{
   ...
   static var RADIAN = 0.017453292519943295;
   ...
   function init()
   {
      ...
      {
         _loc2_ = this.mSprayHolder.attachMovie("_mPukeLine","mPukeLine" + _loc3_,this.mSprayHolder.getNextHighestDepth());
   ...
   function addPuke()
   {
      ...
      else
      {
         ...
         _loc4_ = this.mSplatterHolder.attachMovie("_mPuddle","mPuddle",this.mSplatterHolder.getNextHighestDepth(),{_rotation:Math.random() * 360,_x:_loc2_._x,_y:_loc2_._y,_alpha:Math.random() * 20 + 15});
   ...
   function endGame()
   {
      ...
      {
         _loc3_ = this.mSprayHolder["mPukeLine" + _loc2_];
