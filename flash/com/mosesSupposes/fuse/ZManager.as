class com.mosesSupposes.fuse.ZManager
{
   ...
   function addTween(obj, props, endvals, seconds, ease, delay, callback)
   {
      ...
      {
         _loc6_ = props[_loc41_];
         _loc13_ = _loc36_.indexOf("|" + _loc6_ + "|") > -1;
         _loc16_ = _loc7_.colorProp;
         if(_loc7_ != undefined)
         {
         ...
         _loc3_ = {c:-1,fmp:-1};
         _loc4_ = endvals[_loc41_];
         _loc11_ = _loc20_ == 0 && seconds + delay == 0 || _loc20_ > 0 && seconds == 0;
         _loc10_ = false;
         _loc14_ = _loc15_ != undefined && _loc37_.indexOf("|" + _loc6_ + "|") > -1;
         if(_loc14_ == true)
         {
            _loc3_.fmp = _loc15_;
         ...
         if(_loc13_ == true || _loc14_ == true && _loc6_.indexOf("lor") > -1 && _loc6_.charAt(2) != "l" && _loc11_ == false)
         {
            if(_loc13_ == true)
            {
               ...
               {
                  _loc17_ = !(_loc6_ == "_tint" || _loc6_ == "_tintPercent" || _loc6_ == "_colorReset") ? _loc6_.slice(1) : "tint";
                  _loc8_ = null;
                  _loc12_ = null;
                  if(_loc17_ == "tint")
                  {
                     ...
                     {
                        _loc18_ = com.mosesSupposes.fuse.ZigoEngine.getColorKeysObj(obj).tintPercent;
      ...
      if(_loc21_ == "")
      {
         ...
         {
            _loc42_ = obj._listeners.length > 0;
            if(_loc42_ == true)
            {
   ...
   function removeTween(targs, props, noInit)
   {
      ...
      {
         _loc3_ = _loc15_ != true ? String(_loc9_[_loc18_].__zigoID__) : _loc18_;
         _loc2_ = this.tweens[_loc3_];
         _loc6_ = _loc16_ != true ? _loc11_.props : _loc2_.props;
         for(var _loc13_ in _loc6_)
         {
            _loc5_ = _loc13_ == com.mosesSupposes.fuse.FuseKitCommon.ALLCOLOR && _loc2_.colorProp != undefined;
      ...
      if(com.mosesSupposes.fuse.ZigoEngine._listeners.length > 0)
      {
         ...
         {
            _loc7_ = this.tweens[_loc17_].targ;
   ...
   function alterTweens(type, targs, props, pauseFlag, suppressStartEvents)
   {
      ...
      {
         _loc6_ = _loc13_ != true ? String(_loc8_[_loc15_].__zigoID__) : _loc15_;
         _loc5_ = this.tweens[_loc6_];
         _loc4_ = _loc14_ != true ? _loc11_.props : _loc5_.props;
   ...
   function update(force)
   {
      ...
      {
         _loc10_ = this.tweens[_loc29_];
         _loc6_ = _loc10_.targ;
         _loc28_ = _loc10_.props;
         _loc16_ = _loc6_._listeners.length > 0;
         ...
         else
         {
            for(_loc24_ in _loc28_)
            {
               ...
               {
                  _loc7_ = this.now >= _loc3_.ts + _loc3_.d;
                  if(_loc3_.c == -1)
                  {
                     if(_loc7_ == true)
                     {
                  ...
                  {
                     _loc4_ = {};
                     _loc15_ = _loc7_ == true && (_loc3_.cycles > 1 || _loc3_.cycles == 0);
                     for(var _loc23_ in _loc3_.ch)
                     {
                        _loc9_ = _loc3_.ch[_loc23_];
                        if(_loc7_ == true)
                        {
                        ...
                        if(_global.isNaN(_loc4_[_loc23_]) == false)
                        {
                           ...
                           {
                              _loc14_ = _loc4_.rb << 16 | _loc4_.gb << 8 | _loc4_.bb;
   ...
   function cleanUp(noInit)
   {
      ...
      {
         _loc2_ = this.tweens[_loc4_].targ;
   ...
   function paramsObj(targs, props, endvals)
   {
      ...
      if(_loc6_.allprops == false)
      {
         ...
         for(_loc11_ in _loc1_)
         {
            ...
            {
               _loc8_ = String(_loc1_.splice(_loc2_,1)[0]);
               _loc5_ = _loc4_.splice(_loc2_,1)[0];
               if(_loc8_ == "_scale")
               {
