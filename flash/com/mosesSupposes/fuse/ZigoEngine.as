class com.mosesSupposes.fuse.ZigoEngine
{
   ...
   static function register(classReference)
   {
      ...
      {
         _loc2_ = arguments[_loc4_].registryKey;
   ...
   static function doTween(targets, props, endvals, seconds, ease, delay, callback)
   {
      ...
      for(var _loc13_ in _loc7_)
      {
         ...
         _loc5_ = com.mosesSupposes.fuse.ZigoEngine.instance.addTween(_loc3_,_loc4_.pa,_loc4_.va,seconds,_loc9_,delay,_loc12_);
   ...
   static function getColorTransObj(type, amt, rgb)
   {
      ...
      {
         case "brightness":
            _loc3_ = 100 - Math.abs(amt);
            _loc4_ = amt <= 0 ? 0 : 255 * (amt / 100);
         ...
         case "tint":
            if(rgb != null)
            {
               ...
               _loc5_ = Number(rgb);
               return {ra:100 - amt,rb:(_loc5_ >> 16) * (amt / 100),ga:100 - amt,gb:(_loc5_ >> 8 & 0xFF) * (amt / 100),ba:100 - amt,bb:(_loc5_ & 0xFF) * (amt / 100)};
            }
      }
   ...
   static function getColorKeysObj(targOrTransObj)
   {
      ...
      if(_loc5_ != 0)
      {
         ...
         _loc2_ = _loc3_.tint.toString(16);
         _loc4_ = 6 - _loc2_.length;
         while(_loc4_-- > 0)
         {
            _loc2_ = "0" + _loc2_;
         }
