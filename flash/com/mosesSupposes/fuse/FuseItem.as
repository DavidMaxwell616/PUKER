class com.mosesSupposes.fuse.FuseItem
{
   ...
   function FuseItem(id, o, fuseID)
   {
      ...
      {
         _loc17_ = o[0];
         _loc9_ = _loc17_.action == undefined ? _loc17_ : _loc17_.action;
      ...
      for(var _loc16_ in o)
      {
         ...
         _loc8_ = Boolean(typeof _loc3_.action == "object" && !(_loc3_.action instanceof Array));
         if(_loc8_ == true)
         {
         ...
         _loc4_ = this.parseProfile(_loc5_,_loc7_);
         if(_loc4_ != undefined)
         {
   ...
   static function doTween()
   {
      ...
      for(var _loc3_ in arguments)
      {
         if(typeof arguments[_loc3_] == "object")
         {
            ...
            _loc2_ = new com.mosesSupposes.fuse.FuseItem(com.mosesSupposes.fuse.FuseItem._aInstances.length,arguments[_loc3_],-1);
   ...
   function startItem(targs, scope)
   {
      ...
      {
         _loc12_ = "|start|stop|pause|resume|skipTo|setStartProps|";
         _loc11_ = this._oElements.scope || scope;
         _loc8_ = !(this._oElements.command instanceof Function) ? String(this._oElements.command) : String(this._oElements.command.apply(_loc11_));
         _loc6_ = !(this._oElements.args instanceof Function) ? this._oElements.args : this._oElements.args.apply(_loc11_);
   ...
   function pause(resume)
   {
      ...
      {
         _loc4_ = this._aTweens[_loc12_];
         _loc2_ = _loc4_.targ;
         _loc3_ = _loc4_.props;
         if(resume == true)
         {
            _loc5_ = [];
            _loc6_ = this._aTweens.length;
   ...
   function _sID()
   {
      ...
      {
         _loc4_ = _global.com.mosesSupposes.fuse.Fuse.getInstance(this._nFuseID);
   ...
   function parseProfile(obj, aap)
   {
      ...
      for(_loc2_ in obj)
      {
         ...
         else
         {
            ...
            {
               _loc11_ = !(_loc9_ instanceof Array) ? {} : [];
            ...
            {
               _loc13_ = _loc2_ == "_tintPercent" && _loc4_.colorProp.p == "_tint";
               _loc12_ = _loc2_ == "_tint" && _loc4_.colorProp.p == "_tintPercent";
      ...
      if(_loc15_ == true)
      {
         _loc17_ = _loc3_.oEP.colorProp != undefined;
         _loc7_ = 0;
         while(_loc7_ < 2)
         {
            _loc4_ = _loc7_ != 0 ? _loc3_.oEP : _loc3_.oSP;
            _loc6_ = _loc7_ != 0 ? this._oTemps.sImgE : this._oTemps.sImgS;
            _loc10_ = _loc4_.colorProp.p;
            ...
            {
               _loc14_ = _loc4_._xscale == undefined ? "_scale" : "_xscale";
   ...
   function doTweens(targs, defaultScope, setStart)
   {
      ...
      if(this._aProfiles[0].__buildMode == true)
      {
         ...
         {
            _loc29_ = this._aProfiles[_loc48_].tweenargs;
            ...
            _loc31_ = com.mosesSupposes.fuse.FuseItem._ZigoEngine.doTween.apply(com.mosesSupposes.fuse.FuseItem._ZigoEngine,_loc29_);
            _loc15_ = _loc31_ != null ? _loc31_.split(",") : [];
            if(_loc15_.length > 0)
            {
      ...
      {
         _loc3_ = this._aProfiles[_loc48_];
         _loc9_ = defaultScope;
         ...
         if(_loc3_.event != undefined)
         {
            _loc45_ = !(_loc3_.event instanceof Function) ? _loc3_.event : _loc3_.event.apply(_loc9_);
            _loc56_ = !(_loc3_.eventparams instanceof Function) ? _loc3_.eventparams : _loc3_.eventparams.apply(_loc9_);
            if(_loc45_ != undefined && _loc45_.length > 0)
            {
               _loc20_ = {e:_loc45_,ep:_loc56_,s:_loc9_};
            }
         }
         _loc51_ = !(_loc3_.skipLevel instanceof Function) ? _loc3_.skipLevel : _loc3_.skipLevel.apply(_loc9_);
         _loc33_ = {skipLevel:_loc51_};
         _loc8_ = {skipLevel:_loc51_};
         if(_loc3_.cycles != undefined)
         {
            _loc46_ = !(_loc3_.cycles instanceof Function) ? _loc3_.cycles : _loc3_.cycles.apply(_loc9_);
         ...
         _loc12_ = [];
         _loc43_ = _loc3_.target != undefined ? _loc3_.target : targs;
         _loc21_ = [];
         _loc47_ = false;
         for(_loc7_ in _loc43_)
         {
            _loc5_ = _loc43_[_loc7_];
         ...
         _loc52_ = _loc12_.length == 0 && _loc3_._doTimer != true;
         _loc49_ = _loc3_._doTimer == true && _loc12_.length == 0;
               ...
               for(var _loc58_ in _loc3_.oSP)
               {
                  ...
                  else
                  {
                     if(_loc3_.oAFV[_loc58_] == true && !(_loc58_ == "_colorReset" && _loc5_ == 100) && !(_loc58_ == "_tintPercent" && _loc5_ == 0))
                     {
                        ...
                        {
                           _loc25_ = _global.com.mosesSupposes.fuse.FuseFMP.getFilterProp(_loc30_,_loc58_,true);
                           if(_loc25_ != null)
                           {
                              _loc16_ = _loc25_;
                           }
         ...
         {
            _loc36_ = false;
            _loc44_ = _loc49_ != false ? [0] : _loc12_;
            for(_loc7_ in _loc44_)
            {
               _loc18_ = _loc3_.ease;
               if(_loc18_ instanceof Function)
               {
                  _loc38_ = Function(_loc18_);
               ...
               if(_loc49_ != true)
               {
                  ...
                  if(_loc14_.length > 0)
                  {
                     ...
                     if(_loc15_.length > 0)
                     {
                        _loc32_ = {targ:_loc30_,props:_loc15_,bools:_loc11_,targZID:_loc30_.__zigoID__};
                        if(_loc36_ == false)
                        {
                           _loc8_ = _loc33_;
                  ...
                  if(_loc5_ == o.props[_loc13_])
                  {
                     ...
                     if(_loc4_.length == 0)
                     {
                        ...
                        if(_loc5_ == "__TweenedDelay")
                        {
                           ...
                           {
                              for(_loc9_ in _loc3_.actualTargs)
                              {
