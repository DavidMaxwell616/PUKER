class com.mosesSupposes.fuse.FuseFMP
{
   ...
   static function initialize(target)
   {
      ...
      for(var _loc13_ in arguments)
      {
         ...
         else
         {
            ...
            {
               _loc5_ = new com.mosesSupposes.fuse.FuseFMP.$fclasses[_loc11_]();
               for(_loc8_ in _loc5_)
               {
                  if(typeof _loc5_[_loc8_] != "function")
                  {
                     _loc4_ = _loc11_.substr(0,-6) + "_" + _loc8_;
   ...
   static function deinitialize()
   {
      ...
      for(var _loc8_ in arguments)
      {
         ...
         {
            _loc4_ = new com.mosesSupposes.fuse.FuseFMP.$fclasses[_loc7_]();
            for(_loc5_ in _loc4_)
            {
               if(typeof _loc4_[_loc5_] != "function")
               {
                  _loc3_ = _loc7_.substr(0,-6) + "_" + _loc5_;
         ...
         for(_loc6_ in com.mosesSupposes.fuse.FuseFMP.$shortcuts)
         {
   ...
   static function setFilterProps($obj, $filterOrPropsObj, $propsObj)
   {
      ...
      if(arguments.length == 3)
      {
         ...
         {
            _loc5_ = com.mosesSupposes.fuse.FuseFMP.getFilter($obj[_loc12_],$filterOrPropsObj,true);
            if(_loc5_ != null)
            {
               _loc8_ = com.mosesSupposes.fuse.FuseFMP.getFilterName(_loc5_).substr(0,-6) + "_";
      ...
      else if(typeof $filterOrPropsObj == "object")
      {
         ...
         for(_loc3_ in $propsObj)
         {
            _loc9_ = _loc3_.split("_");
            _loc10_ = _loc9_[0] + "Filter";
   ...
   static function getAllShortcuts()
   {
      ...
      {
         _loc1_ = new com.mosesSupposes.fuse.FuseFMP.$fclasses[_loc4_]();
   ...
   static function traceAllFilters()
   {
      ...
      {
         _loc1_ += _loc4_;
         _loc2_ = new com.mosesSupposes.fuse.FuseFMP.$fclasses[_loc4_]();
